...
plt1 = plot(phis1F,mode='color',vmin=0.,vmax=0.7, interactive=False, scalarbar=False)
# plt2 = plot(phil, add=True, scalarbar='horizontal')
plt2 = plot(philF,mode='color', add=True)
plt3 = plot(phis3F,mode='color',vmin=0.,vmax=0.7, add=True, scalarbar=False)
plot()



# yvals = phis1F.compute_vertex_values(mesh1)
# xvals = np.arange(len(yvals))
# plt = plot(xvals, yvals, 'go-')
# plt.show(newPlotter=True)
#
# hst = np.histogram(yvals)
