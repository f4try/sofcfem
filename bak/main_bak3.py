...
dx1 = Measure("dx", domain=V1.mesh())
dx2 = Measure("dx", domain=V2.mesh())
dx3 = Measure("dx", domain=V3.mesh())
ds1 = Measure('ds', domain=V1.mesh(), subdomain_data=boundary_markers1)
ds2 = Measure('ds', domain=V2.mesh(), subdomain_data=boundary_markers2)
ds3 = Measure('ds', domain=V3.mesh(), subdomain_data=boundary_markers3)
